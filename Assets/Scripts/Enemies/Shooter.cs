...
public class Shooter : MonoBehaviour, IEnemy
{
    ...
    {
        float x = transform.position.x + Mathf.Cos(currentAngle * Mathf.Deg2Rad) * startingDistance;
        float y = transform.position.y + Mathf.Sin(currentAngle * Mathf.Deg2Rad) * startingDistance;
